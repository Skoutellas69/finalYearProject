...
public class MyModelingAssistantProvider extends ModelingAssistantProvider {
	...
	protected EObject selectElement(EObject[] elements) {
		...
		ElementListSelectionDialog dialog = new ElementListSelectionDialog(
				shell, labelProvider);
		dialog.setMessage(finalYearName.diagram.part.Messages.MyModelingAssistantProviderMessage);
		dialog.setTitle(finalYearName.diagram.part.Messages.MyModelingAssistantProviderTitle);
