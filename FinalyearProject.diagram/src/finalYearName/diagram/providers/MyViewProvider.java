...
public class MyViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				if (!finalYearName.diagram.providers.MyElementTypes
		...
		return finalYearName.diagram.edit.parts.SoftGoalEditPart.VISUAL_ID == visualID
				...
				|| finalYearName.diagram.edit.parts.AttackMethodEditPart.VISUAL_ID == visualID
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(finalYearName.diagram.edit.parts.ModelEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case finalYearName.diagram.edit.parts.DependencyLinkEditPart.VISUAL_ID:
			return createDependencyLink_4001(
	 ...
	 * @generated
	 */
	public Node createSecurityMechanism_2003(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createPlan_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createThreat_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createSecurityObjective_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createGoal_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Edge createDependencyLink_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(finalYearName.diagram.part.MyVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!finalYearName.diagram.edit.parts.ModelEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", finalYearName.diagram.edit.parts.ModelEditPart.MODEL_ID); //$NON-NLS-1$
