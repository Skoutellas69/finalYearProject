 ...
 * @generated
 */
public class PlanEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new finalYearName.diagram.edit.policies.PlanItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new PlanFigure();
	}
