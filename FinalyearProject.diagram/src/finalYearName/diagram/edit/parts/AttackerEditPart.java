 ...
 * @generated
 */
public class AttackerEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AttackerEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new finalYearName.diagram.edit.policies.AttackerItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new AttackerFigure();
	}

	/**
	 * @generated
	 */
	public AttackerFigure getPrimaryShape() {
		return (AttackerFigure) primaryShape;
	}
