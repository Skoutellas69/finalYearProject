 ...
 * @generated
 */
public class ThreatEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new finalYearName.diagram.edit.policies.ThreatItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ThreatFigure();
	}
	...
	public ThreatFigure getPrimaryShape() {
		return (ThreatFigure) primaryShape;
	}
