...
public class ModelCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<finalYearName.diagram.part.MyNodeDescriptor> childDescriptors = finalYearName.diagram.part.MyDiagramUpdater
				.getModel_1000SemanticChildren(viewObject);
		for (finalYearName.diagram.part.MyNodeDescriptor d : childDescriptors) {
	...
	protected void refreshSemantic() {
		...
		for (Iterator<finalYearName.diagram.part.MyNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			finalYearName.diagram.part.MyNodeDescriptor next = descriptorsIterator
					.next();
			String hint = finalYearName.diagram.part.MyVisualIDRegistry
		...
		for (finalYearName.diagram.part.MyNodeDescriptor next : childDescriptors) {
			String hint = finalYearName.diagram.part.MyVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<finalYearName.diagram.part.MyLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = finalYearName.diagram.part.MyVisualIDRegistry
			...
			for (Iterator<finalYearName.diagram.part.MyLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				finalYearName.diagram.part.MyLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<finalYearName.diagram.part.MyLinkDescriptor> collectAllLinks(
		...
		case finalYearName.diagram.edit.parts.OrganisationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(finalYearName.diagram.part.MyDiagramUpdater
						.getOrganisation_2009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case finalYearName.diagram.edit.parts.PlanEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(finalYearName.diagram.part.MyDiagramUpdater
						.getPlan_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case finalYearName.diagram.edit.parts.ThreatEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(finalYearName.diagram.part.MyDiagramUpdater
						.getThreat_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case finalYearName.diagram.edit.parts.SecurityConstraintEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(finalYearName.diagram.part.MyDiagramUpdater
						.getSecurityConstraint_2006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case finalYearName.diagram.edit.parts.VulnerabilityEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(finalYearName.diagram.part.MyDiagramUpdater
						.getVulnerability_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case finalYearName.diagram.edit.parts.DependencyLinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(finalYearName.diagram.part.MyDiagramUpdater
						.getDependencyLink_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	private Collection<IAdaptable> createConnections(
			Collection<finalYearName.diagram.part.MyLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (finalYearName.diagram.part.MyLinkDescriptor nextLinkDescriptor : linkDescriptors) {
